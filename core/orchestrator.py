...
IMMEDIATE_ACKS = {
    ...
    "list_open_windows": "Checking what's open.",
    "get_active_window": "Checking the active window.",
    "focus_window": "Switching to it.",
    "read_window_text": "Reading that window.",
    "type_text": "Typing.",
    "press_key": "On it.",
    "hotkey": "On it.",
    "move_mouse": None,  # too fast/frequent to be worth a spoken ack
    "click": None,
    ...
    "quick_note": "Saving that note.",
    "create_file": "Creating file.",
    "open_system_folder": "Opening folder.",
    "find_and_open_file": "Opening file.",
    "media_control": "On it.",
    "window_action": "On it.",
